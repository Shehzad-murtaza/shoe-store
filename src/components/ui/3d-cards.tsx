...
interface CardItemProps {
  ...
  translateX?: number;
  translateY?: number;
  translateZ?: number;  // Ensure it's a number
  rotateX?: number;
  rotateY?: number;
  rotateZ?: number;
  onClick?: React.MouseEventHandler<HTMLElement>;  // Add onClick to the props
}


export const CardItem: React.FC<CardItemProps> = ({
  as: Tag = "div", // Default to 'div', but can be customized
  children,
  className,
  translateX = 0,
  translateY = 0,
